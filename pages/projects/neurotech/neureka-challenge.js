...
import projectImgHeader from "../../../public/projects/neureka/neureka.png";

const NeurekaChallenge = () => {
  return (
    <div className="w-full">
      <div className="w-screen h-[30vh] lg:h-[40vh] relative">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%]  translate-y-[-50%] text-white z-10 p-2">
          <h2>Neureka Challenge</h2>
          <h3>Deep Learning for EEG Challenge on Seizure Prediction</h3>
        </div>
      </div>

      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          <p>Neureka Challenge</p>
          <h2>Overview</h2>
...
export default NeurekaChallenge;
